...
g["axpy!", s]     = @benchmarkable BLAS.axpy!($n, $v, $v)
g["scal!", s]     = @benchmarkable BLAS.scal!($s, $n, $v, 1)
g["scal", s]      = @benchmarkable BLAS.scal($s, $n, $v, 1)
g["ger!", s]      = @benchmarkable BLAS.ger!($n, $v, $v, $m)
g["syr!", s]      = @benchmarkable BLAS.syr!('U', 1.0, $v, $m)
g["syrk!", s]     = @benchmarkable BLAS.syrk!('U', 'N', $n, $m, $n, $m)
g["syrk", s]      = @benchmarkable BLAS.syrk('U', 'N', $n, $m)
g["her!", s]      = @benchmarkable BLAS.her!('U', $n, $cv, $cm)
g["herk!", s]     = @benchmarkable BLAS.herk!('U', 'N', $n, $cm, $n, $cm)
g["herk", s]      = @benchmarkable BLAS.herk('U', 'N', $n, $cm)
g["gbmv!", s]     = @benchmarkable BLAS.gbmv!('N', $s, 1, 1, $n, $m, $v, $n, $v)
g["gbmv", s]      = @benchmarkable BLAS.gbmv('N', $s, 1, 1, $n, $m, $v)
g["sbmv!", s]     = @benchmarkable BLAS.sbmv!('U', $s-1, $n, $m, $v, $n, $v)
g["sbmv", s]      = @benchmarkable BLAS.sbmv('U', $s-1, $n, $m, $v)
g["gemm!", s]     = @benchmarkable BLAS.gemm!('N', 'N', $n, $m, $m, $n, $m)
g["gemm", s]      = @benchmarkable BLAS.gemm('N', 'N', $n, $m, $m)
g["gemv!", s]     = @benchmarkable BLAS.gemv!('N', $n, $m, $v, $n, $v)
g["gemv", s]      = @benchmarkable BLAS.gemv('N', $n, $m, $v)
g["symm!", s]     = @benchmarkable BLAS.symm!('L', 'U', $n, $m, $m, $n, $m)
g["symm", s]      = @benchmarkable BLAS.symm('L', 'U', $n, $m, $m)
g["symv!", s]     = @benchmarkable BLAS.symv!('U', $n, $m, $v, $n, $v)
