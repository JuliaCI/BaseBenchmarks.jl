...
# |x| >= 2.0^20π/2
# idx < 0
g["argument reduction (easy) |x| > 2.0^20*π/2", "positive argument", "Float64", "sin_kernel"] = @benchmarkable sin($(2.0^30*pi/4-0.1))
g["argument reduction (easy) |x| > 2.0^20*π/2", "negative argument", "Float64", "sin_kernel"] = @benchmarkable sin($(-2.0^30*pi/4+0.1))
# idx > 0
g["argument reduction (easy) |x| > 2.0^20*π/2", "positive argument", "Float64", "cos_kernel"] = @benchmarkable sin($(2.0^80*pi/4-1.2))
...
# |x| >= 2.0^20π/2
# idx < 0
g["argument reduction (easy) |x| > 2.0^20*π/2", "positive argument", "Float64", "cos_kernel"] = @benchmarkable cos($(2.0^30*pi/4-0.1))
g["argument reduction (easy) |x| > 2.0^20*π/2", "negative argument", "Float64", "cos_kernel"] = @benchmarkable cos($(-2.0^30*pi/4+0.1))
# idx > 0
g["argument reduction (easy) |x| > 2.0^20*π/2", "positive argument", "Float64", "sin_kernel"] = @benchmarkable cos($(2.0^80*pi/4-1.2))
g["argument reduction (easy) |x| > 2.0^20*π/2", "negative argument", "Float64", "sin_kernel"] = @benchmarkable cos($(-2.0^80*pi/4+1.2))
